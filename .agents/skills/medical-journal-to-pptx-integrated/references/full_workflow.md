...
LibreOffice and Poppler are required for final delivery. Export the PPTX to PDF,
render every page, verify preview and PDF page counts match, and inspect the
complete contact sheet plus readable individual pages. A structural PPTX pass
alone is not a full-quality completion.
